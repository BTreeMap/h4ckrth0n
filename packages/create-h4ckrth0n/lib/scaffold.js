...
function buildEnvContent(dbType, projectName) {
  ...
  return [
    "# h4ckrth0n environment",
    "H4CKRTH0N_ENV=development",
    `H4CKRTH0N_DATABASE_URL=${dbUrl}`,
    `H4CKRTH0N_AUTH_SIGNING_KEY=${signingKey}`,
    "H4CKRTH0N_RP_ID=localhost",
    "H4CKRTH0N_ORIGIN=http://localhost:5173",
...
function buildEnvExampleContent(dbType) {
  ...
  return [
    "# h4ckrth0n environment",
    "H4CKRTH0N_ENV=development",
    `H4CKRTH0N_DATABASE_URL=${dbPlaceholder}`,
    "H4CKRTH0N_AUTH_SIGNING_KEY=<random-hex-secret>",
    "H4CKRTH0N_RP_ID=localhost",
    "H4CKRTH0N_ORIGIN=http://localhost:5173",
    "VITE_API_BASE_URL=/api",
    "",
