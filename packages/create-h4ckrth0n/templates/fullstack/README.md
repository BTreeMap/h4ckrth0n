...
Full-stack hackathon project scaffolded with [h4ckrth0n](https://github.com/BTreeMap/h4ckrth0n).
...
```
{{PROJECT_NAME}}/
  backend/    Python (FastAPI + h4ckrth0n library)
...
Copy `.env.example` to `.env` and set values as needed. See the h4ckrth0n docs for all configuration options.
